...
namespace Kira.IdentityService.API.Controllers
{
    ...
    public class AccountController(IAccountService accountService, ICookieService cookieService) : ControllerBase
    {
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequest loginRequest)
        {
            ...
            cookieService.SetResponseCookie(RefreshTokenCookieKey, loginResponse.RefreshToken, loginResponse.RefreshTokenExpirationTime, true,
                SameSiteMode.Strict);
        ...
        {
            if (!cookieService.TryGetRequestCookie(RefreshTokenCookieKey, out var refreshToken) || string.IsNullOrEmpty(refreshToken))
            {
