...
namespace Kira.IdentityService.API.Migrations;
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable("RefreshTokens",
            table => new
            {
                ...
                UserId = table.Column<string>("text", nullable: false),
                IsUsed = table.Column<bool>("boolean", nullable: false),
                ExpirationTime = table.Column<DateTime>("timestamp with time zone", nullable: false)
            }, constraints: table =>
            {
                table.PrimaryKey("PK_RefreshTokens", x => x.Id);

                table.ForeignKey("FK_RefreshTokens_AspNetUsers_UserId", x => x.UserId, "AspNetUsers", "Id",
                    onDelete: ReferentialAction.Cascade);
            });
