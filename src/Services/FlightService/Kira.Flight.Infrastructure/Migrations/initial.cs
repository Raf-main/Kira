...
public partial class initial : Migration
{
    ...
    {
        migrationBuilder.CreateTable("Airplanes", table => new
        {
        ...
        migrationBuilder.CreateTable("Airports", table => new
        {
            Id = table.Column<Guid>("uuid", nullable: false),
            Name = table.Column<string>("character varying(32)", maxLength: 32, nullable: false)
        }, constraints: table => { table.PrimaryKey("PK_Airports", x => x.Id); });

        migrationBuilder.CreateTable("Seats", table => new
        {
            Id = table.Column<Guid>("uuid", nullable: false),
        ...
        migrationBuilder.CreateTable("Flights", table => new
        {
            Id = table.Column<Guid>("uuid", nullable: false),
